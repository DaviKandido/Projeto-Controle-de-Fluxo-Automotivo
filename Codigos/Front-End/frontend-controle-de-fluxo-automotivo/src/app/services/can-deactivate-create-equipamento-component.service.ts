...
export class CanDeactivateCreateEquipamentoComponentService
  implements CanDeactivate<CreateEquipamentoComponent>
{
  canDeactivate(component: CreateEquipamentoComponent) {
    if (
      component.equipamentoForm &&
      (component.equipamentoForm.dirty || component.equipamentoForm.touched)
    ) {
